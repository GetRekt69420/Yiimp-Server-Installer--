...
#                                                                                                         #
#  curl https://raw.githubusercontent.com/GetRekt69420/Yiimp-Server-Installer--/master/bootstrap.sh | bash # 
#                                                                                                         #
###########################################################################################################
...
git clone https://github.com/GetRekt69420/yiimp_server_setup-- "$HOME"/yiimpserver/install < /dev/null 2> /dev/null
echo
